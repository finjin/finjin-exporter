...
namespace Finjin { namespace Exporter {
    ...
    class VRayMaterialsExporterHandler : public MayaBaseMaterialExporterHandler
    {
    public:
        VRayMaterialsExporterHandler();
    ...
    /** Handler factory for exporting VRay materials. */
    class VRayMaterialsExporterHandlerFactory : public MaterialExporterHandlerFactory
    {
    public:
        bool CanHandle(MaterialAccessor material) const override
        {
            return VRayMaterialsExporterHandler::CanHandle(material);
        }

        MaterialExporterHandler* CreateHandler() override
        {
            return new VRayMaterialsExporterHandler;
        }

        static VRayMaterialsExporterHandlerFactory& GetInstance()
        {
            static VRayMaterialsExporterHandlerFactory instance;
            return instance;
        }
    };
