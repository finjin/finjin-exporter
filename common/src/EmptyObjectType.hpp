...
namespace Finjin { namespace Exporter {
    ...
    /** DetectableObjectType for an object that contains no other objects. */
    class EmptyObjectType : public DetectableObjectType
    {
    public:
        ...
        {
        public:
            const wxString& GetTypeName() const override {static const wxString name(wxT("empty")); return name;}
            const wxString& GetDisplayName() const override {static const wxString name(wxT("Empty")); return name;}
        ...
        static EmptyObjectType& GetInstance()
        {
            static EmptyObjectType detector;
            return detector;
        }
